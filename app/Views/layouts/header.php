    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="text-light small text-end d-none d-sm-block">
                    <div class="fw-semibold"><?= $nomeUsuario ?></div>
                    <div class="opacity-75" style="font-size: 0.75rem;"><?= $perfilUsuario ?></div>
                </div>
                <a class="btn btn-sm btn-outline-light" href="<?= $baseUrl ?>?controller=auth&action=logout">
                    Sair
                </a>
            </div>
        </div>
